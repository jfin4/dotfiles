...
static const char *fonts[]          = { "SourceSans:size=14" };
static const char dmenufont[]       = "SourceSans:size=14";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg, "-nf", col_norm, "-sb", col_bg, "-sf", col_sel, NULL };

...
highlight Cursor            ctermfg=black      ctermbg=blue     cterm=NONE guifg=alt_black     guibg=alt_blue     gui=NONE
...
highlight DiffAdd           ctermfg=green     ctermbg=NONE  cterm=NONE guifg=alt_green     guibg=NONE  gui=NONE
...
highlight DiffText          ctermfg=black     ctermbg=yellow  cterm=NONE guifg=alt_black     guibg=alt_yellow  gui=NONE
...
highlight VertSplit         ctermfg=NONE      ctermbg=NONE  cterm=NONE guifg=alt_black          guibg=NONE  gui=NONE
highlight Folded            ctermfg=lightgray ctermbg=NONE  cterm=NONE guifg=alt_lightgray guibg=NONE  gui=NONE
highlight FoldColumn        ctermfg=lightgray ctermbg=NONE  cterm=NONE guifg=alt_lightgray guibg=NONE  gui=NONE
highlight SignColumn        ctermfg=lightgray ctermbg=NONE      cterm=NONE guifg=alt_lightgray guibg=NONE          gui=NONE
highlight IncSearch         ctermfg=NONE      ctermbg=darkgray  cterm=NONE guifg=NONE          guibg=alt_darkgray  gui=NONE
highlight LineNr            ctermfg=lightgray ctermbg=NONE      cterm=NONE guifg=alt_lightgray guibg=NONE          gui=NONE
highlight LineNrAbove       ctermfg=lightgray ctermbg=NONE      cterm=NONE guifg=alt_lightgray guibg=NONE          gui=NONE
highlight LineNrBelow       ctermfg=lightgray ctermbg=NONE      cterm=NONE guifg=alt_lightgray guibg=NONE          gui=NONE
...
highlight MatchParen        ctermfg=black      ctermbg=yellow  cterm=NONE guifg=alt_black          guibg=alt_yellow  gui=NONE
...
highlight StatusLine        ctermfg=lightgray      ctermbg=NONE  cterm=NONE guifg=alt_lightgray          guibg=NONE  gui=NONE
highlight StatusLineNC      ctermfg=lightgray ctermbg=NONE  cterm=NONE guifg=alt_lightgray guibg=NONE  gui=NONE
...
highlight Visual            ctermfg=black     ctermbg=yellow    cterm=NONE guifg=alt_black          guibg=alt_yellow  gui=NONE

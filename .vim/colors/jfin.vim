...
call Hl('pmenuextrasel',     { 'bg': 'lightgray'})
call Hl('pmenukind',         { 'bg': 'darkgray'})
call Hl('pmenukindsel',      { 'bg': 'lightgray'})
call Hl('pmenumatch',        { 'bg': 'darkgray'})
call Hl('pmenumatchsel',     { 'bg': 'lightgray'})
call Hl('pmenusbar',         { 'bg': 'darkgray'})
call Hl('pmenusel',          { 'bg': 'lightgray'})
call Hl('pmenuthumb',        { 'bg': 'lightgray'})
...
call Hl('statusline',        { 'fg': 'lightgray', 'bg': 'black'})
call Hl('statuslinenc',      { 'fg': 'lightgray', 'bg': 'black'})
call Hl('statuslineterm',    { 'fg': 'lightgray', 'bg': 'black'})
call Hl('statuslinetermnc',  { 'fg': 'lightgray', 'bg': 'black'})
...
call Hl('vertsplit',         { 'fg': 'black', 'bg': 'black'})

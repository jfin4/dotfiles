...
alias pull-all='sync-all-repos pull'
alias pull='pull-repo'
alias push-all='sync-all-repos push'
alias push='push-repo'
alias pw='cat ~/passwords/waterboard > /dev/clipboard'
alias remove='pacman -Rns'
alias rm='move-to-trash'
alias search='pacman -Ss'
alias summary='Rscript ~/scripts/get-summary.r $(cygpath -w $USERPROFILE/msys/home/jfin/hours) && push-all > /dev/null'
